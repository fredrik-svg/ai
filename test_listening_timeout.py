...
class MockArray:
    def __init__(self, data, dtype=None):
        self.data = data
        self.dtype = dtype
        self.shape = (len(data), 1) if isinstance(data, list) else (1,)
...
mock_np.zeros = lambda shape, dtype=None: MockArray([0] * (shape[0] if isinstance(shape, tuple) else shape), dtype)
mock_np.int16 = 'int16'
